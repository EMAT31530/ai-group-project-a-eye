...
for i in range(0, 1000):
    output = Minimaxab_vs_Random.main()
    print(output)
...
labels = ['Minimax with alphabeta vs Random player']
win = [win]
draw = [draw]
...
ax.set_title('Outcome of games of an Intelligent (Minimax) vs Random player with pruning')
ax.set_xticks(x)
